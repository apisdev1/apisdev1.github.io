...
function setOccupancyDisplay(occupancy) {
    ...
    if (occupancy == 2) {
        ...
        document.getElementById('occupancy').innerHTML = '1 out of 3 spaces are available in this space.';
        document.getElementById('instruction').innerHTML = 'Tap your fob to check in or out of this room.';
    } else {
        // Max Capacity
        document.getElementById('glyph').innerHTML = '\u2716';
        document.getElementById('occupancy').innerHTML = 'Space is now at capacity: 3 spots out of 3 are taken.';
        document.getElementById('instruction').innerHTML = 'Please wait until a spot open up.';
    }
}